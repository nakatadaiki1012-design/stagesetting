...
(function (SS) {
  ...
  function renderCompareBar() {
    ...
    if ($('cmpNote')) $('cmpNote').onclick = () => {
      ...
      toast(`変更の内容を「${doc().info.changeNote}」にしました（「🖼 画像」の画面の「図面の情報欄」で直せます）`, true);
    };
  }
  ...
  function showHelp() {
    openModal(`
      ...
      <ol>
        ...
        <li><b>舞台図面として配る</b>：「🖼 画像」で <b>PNG・PDF・SVG</b>、「🖨 印刷」で紙に出せます。<b>用紙（A4・A3、縦・横）と縮尺（1/50・1/100・1/200・用紙に合わせる）</b>をえらぶと、紙の上の長さが実際の寸法どおりになります（1/100 なら 1m が 1cm）。図には<b>上手・下手・客席・センター</b>、スケールバー、右下に<b>情報欄</b>（公演名・会場・日付・版・作った人・縮尺・メモ）が入ります。情報欄の中身は、この画面の「図面の情報欄」で入れます。舞台が用紙に入らないときは、入る縮尺を教えてくれます。印刷は倍率「100%」で。</li>
        ...
        <li><b>版</b>：「名前を付けて保存」のとき、<b>第何版かを1つ上げるか</b>聞きます。「🖼 画像」の画面の「図面の情報欄」で手で直すこともできます。</li>
