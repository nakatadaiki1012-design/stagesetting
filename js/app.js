  ...
  function showHelp() {
    openModal(`
      ...
      <ol>
        ...
        <li><b>編成の種類</b>：「かんたん編成」で <b>吹奏楽・オーケストラ・弦楽・ブラスバンド・ビッグバンド・合唱</b> を選べます。<b>ブラスバンド</b>（ブリティッシュ・スタイル）は前の列にソロ・コルネット→フリューゲル→テナーホルン→バリトン→ユーフォ、後ろの列にソプラノ・レピアノ・2nd・3rdコルネット→ベース（真ん中）→トロンボーン。<b>ビッグバンド</b>はサックス（前・リードのA1が真ん中）→トロンボーン（1段目）→トランペット（2段目）、リズム隊（ピアノ・ギター・ベース・ドラム）は下手にまとめます。<b>合唱</b>は立って歌う人の形で、S・A・T・B を下手から／女声が前・男声が後ろ／S・T・B・A から選べ、前の列は床、うしろの列はひな壇（半人分ずらす）、ピアノは下手に置きます。</li>
        ...
        <li><b>⚠ 確認</b>：舞台奥の通路が狭い・<b>指揮台の前が1mより狭い</b>・<b>椅子・譜面台・楽器が重なっている</b>・<b>ひな壇の縁にかかっている</b>・高い段に上がり段がない・重い楽器を段に上げる通路（幅1.2m）がない・緞帳線や迫りの上に物がある、などを見つけると、舞台図の左上に <b>「⚠ 確認 ○件」</b> が出ます。押すと一覧が開き、1つ押すとその場所を<b>赤い点線の枠</b>で示します。一覧のいちばん上の<b>「🔧 自動で直す」</b>を押すと、指揮台の前・舞台奥の通路・ひな壇の縁・重なり・上がり段を、形をくずさずに直します（「戻す」で元に戻せます）。直せなかった所は一覧に残ります。</li>
