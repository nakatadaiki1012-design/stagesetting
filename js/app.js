  ...
  function showHelp() {
    openModal(`
      ...
      <ol>
        ...
        <li><b>司会・照明のテスト</b>：「部品」の <b>司会（マイクスタンド）</b> で司会の位置を決め、3D の <b>「💡 照明」</b> で、地明かりの明るさ・反射板を下から色で照らす・上から色の明かり・<b>ピンスポット</b>（当てる人・どこから・大きさ・色）をためせます。照明の設定は配置図といっしょに保存されます。</li>
