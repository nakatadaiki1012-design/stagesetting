  ...
  function showHelp() {
    openModal(`
      ...
      <ol>
        ...
        <li><b>打楽器</b>：「かんたん編成」の「打楽器」の箱の「打楽器の場所」で<b>舞台奥・ひな壇の最上段・下手側・最上段＋下手</b>を選べます。吹奏楽の<b>「下手側」</b>は、床の扇形のすぐ外側（客席から見て左）に、<b>前（客席寄り）から弧に沿って指揮者の方を向けて</b>並べます（鍵盤を前、太鼓類・ティンパニを奥）。「🥁 打楽器を整列」でその場所に並べ直せます。</li>
