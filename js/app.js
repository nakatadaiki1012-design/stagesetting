...
(function (SS) {
  ...
  function showHelp() {
    openModal(`
      <h2>🎼 使い方</h2>
      <ol>
        <li><b>✍️ 文章で指示する</b>：「フルート6人、打楽器は下手、ひな壇2段、ミューザで」のように書いて押すと、その通りに並べ直します。「コンクールA」「小編成」「55人くらい」のような言い方もわかります。読み取れなかったときは、書き方の例が出ます。</li>
        ...
        <li><b>かんたん編成</b>：ホールを選んで、パートの人数を▲▼で変えるだけ。<b>すぐに自動で並べ直します</b>。ステージは<b>音響反射板を置いたときの形</b>（前が広く奥がせまい台形）になり、はみ出さないように詰めて並べます。人数が0人のパート（Es.Cl・ハープなど）は隠れているので、「＋パートを追加」で出します。</li>
        ...
        <li><b>打楽器</b>：「かんたん編成」の「打楽器」の箱の「打楽器の場所」で<b>舞台奥・ひな壇の最上段・下手側・最上段＋下手</b>を選べます。「🥁 打楽器を整列」でその場所に並べ直せます。</li>
        ...
        <li><b>🧊 3D</b>：客席から・指揮者から・<b>奏者の席に座った目線</b>で、立体で見られます（奏者をタップするとその席に座れます）。3Dの表示には<b>インターネット接続が必要</b>です。</li>
        ...
        <li><b>⚠ 確認</b>：舞台奥の通路が狭い・<b>指揮台の前が1mより狭い</b>・<b>椅子・譜面台・楽器が重なっている</b>・<b>ひな壇の縁にかかっている</b>・高い段に上がり段がない・重い楽器を段に上げる通路（幅1.2m）がない・緞帳線や迫りの上に物がある、などを見つけると、舞台図の左上に <b>「⚠ 確認 ○件」</b> が出ます。押すと一覧が開き、1つ押すとその場所を<b>赤い点線の枠</b>で示します。</li>
        ...
        <li><b>ホールの設備</b>：「かんたん編成」の「安全・ホールの設備」→「ホールの設備」に、反射板の位置・プロセニアム・緞帳線・迫り・オーケストラピットのふた・花道を<b>分かるものだけ</b>入れると、図に描き、重なった物を「⚠ 確認」で知らせます。</li>
