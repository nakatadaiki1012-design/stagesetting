...
(function (SS) {
  ...
  SS.CATALOG = {
    ...
    door:    { name: '出入り口（扉）', cat: '舞台の設備・その他', w: 180, h: 134, shape: 'door', fill: '#2f9e57', label: '出入口', note: '舞台の横か奥の壁の近くに置くと、壁にくっついて内側を向きます。舞台の外（そで・奥の通路）に出すと、置いた所のまま舞台のほうを向きます（Alt を押しながらだと向きも変えません）。緑の太線が扉、点線の所（扉の前1.2m）に人や物があると「⚠ 確認」に出ます' },
