...
(function (SS) {
  ...
  SS.CATALOG = {
    ...
    mc:      { name: '司会（マイクスタンド）', cat: '舞台の設備・その他', w: 60, h: 70, shape: 'mc', fill: '#3a3f48', label: '司会', note: '立って話す人と、前にマイクスタンド。3D の「💡 照明」で、ピンスポットを当てる相手に選べます' },
    door:    { name: '出入り口（扉）', cat: '舞台の設備・その他', w: 180, h: 134, shape: 'door', fill: '#2f9e57', label: '出入口', note: '舞台の横か奥の壁の近くに置くと、壁にくっついて内側を向きます。舞台のすぐ外（壁から1.5m以内）に置くと、壁の外側にくっついて、そでの方へ開く形になります。それより遠くに出すと、置いた所のまま舞台のほうを向きます（Alt を押しながらだと、くっつかず向きも変えません）。緑の太線が扉、点線の所（扉の前1.2m）に人や物があると「⚠ 確認」に出ます' },
